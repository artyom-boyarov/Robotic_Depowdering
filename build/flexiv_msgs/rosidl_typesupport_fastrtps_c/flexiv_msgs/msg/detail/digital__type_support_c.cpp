...
#include "flexiv_msgs/msg/detail/digital__rosidl_typesupport_fastrtps_c.h"
...
using _Digital__ros_msg_type = flexiv_msgs__msg__Digital;
...
static uint32_t _Digital__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_flexiv_msgs__msg__Digital(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = flexiv_msgs__msg__Digital;
    is_plain =
      (
...
static size_t _Digital__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_flexiv_msgs__msg__Digital(
