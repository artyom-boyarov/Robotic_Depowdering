...
#include "flexiv_msgs/msg/detail/mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const flexiv_msgs::msg::Mode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  flexiv_msgs::msg::Mode & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = flexiv_msgs::msg::Mode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const flexiv_msgs::msg::Mode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<flexiv_msgs::msg::Mode *>(
    untyped_ros_message);
...
{
  return &flexiv_msgs::msg::typesupport_fastrtps_cpp::_Mode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, flexiv_msgs, msg, Mode)() {
  return &flexiv_msgs::msg::typesupport_fastrtps_cpp::_Mode__handle;
}
