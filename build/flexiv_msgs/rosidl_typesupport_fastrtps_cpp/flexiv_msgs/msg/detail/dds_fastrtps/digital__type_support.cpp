...
#include "flexiv_msgs/msg/detail/digital__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const flexiv_msgs::msg::Digital & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  flexiv_msgs::msg::Digital & ros_message)
{
  // Member: pin
  cdr >> ros_message.pin;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = flexiv_msgs::msg::Digital;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const flexiv_msgs::msg::Digital *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<flexiv_msgs::msg::Digital *>(
    untyped_ros_message);
...
{
  return &flexiv_msgs::msg::typesupport_fastrtps_cpp::_Digital__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, flexiv_msgs, msg, Digital)() {
  return &flexiv_msgs::msg::typesupport_fastrtps_cpp::_Digital__handle;
}
