...
{
  new (message_memory) flexiv_msgs::msg::Digital(_init);
}

void Digital_fini_function(void * message_memory)
{
  auto typed_message = static_cast<flexiv_msgs::msg::Digital *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Digital_message_member_array[2] = {
  {
    ...
    offsetof(flexiv_msgs::msg::Digital, pin),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(flexiv_msgs::msg::Digital, state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Digital_message_members = {
  ...
  2,  // number of fields
  sizeof(flexiv_msgs::msg::Digital),
...
{
  return &::flexiv_msgs::msg::rosidl_typesupport_introspection_cpp::Digital_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, flexiv_msgs, msg, Digital)() {
  return &::flexiv_msgs::msg::rosidl_typesupport_introspection_cpp::Digital_message_type_support_handle;
}
